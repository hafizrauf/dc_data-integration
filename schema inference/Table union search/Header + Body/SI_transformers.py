...
dim = 1365  #693 for TabNet, 208 for TabTransformer, 768 for SBERT

vectors=pd.read_csv('X.txt', header =None, sep = ' ')
...
pretrain_path = 'src/DeepClusteringAlgorithm/SDCN/' + 'data/{}.pkl'.format('dataset1')
n_input = dim
