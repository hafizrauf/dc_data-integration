...
def custom_params():
    ...
    parser.add_argument('--target_type', type=str, default="custom")
    parser.add_argument('--train_percent', type=float, default=0.08)
    parser.add_argument('--cuda', type=bool, default=False)
    parser.add_argument('--gpu', type=int, default=0)
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--hidden_dim', type=int, default=[1000])  # set to the dimensionality of your data
    ...
    parser.add_argument('--type_att_size', type=int, default=64)
    parser.add_argument('--warm_epochs', type=int, default=50)
    parser.add_argument('--compress_ratio', type=int, default=0.06)  # adjust as needed
